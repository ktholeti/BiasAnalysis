...
wh_m_names = ['adam', 'alan', 'andrew', 'brad', 'brandon', 'chip', 'frank', 'fred', 'greg', 'hank', 'harry', 'ian',
              'jack', 'jed', 'jonathan', 'josh', 'justin', 'matthew', 'paul', 'peter', 'roger', 'ryan', 'stephen',
              'todd', 'wilbur']
wh_f_names = ['amanda', 'amber', 'betsy', 'colleen', 'courtney', 'crystal', 'donna', 'ellen', 'emily', 'heather',
              'katie', 'kristin', 'lauren', 'megan', 'melanie', 'meredith', 'nancy', 'peggy', 'rachel', 'sara',
              'shannon', 'stephanie', 'ellen', 'wendy']
bl_m_names = ['alonzo', 'alphonse', 'darnell', 'deion', 'everol', 'jamel', 'jerome', 'lamar', 'lamont', 'lavon',
              'lerone', 'leroy', 'lionel', 'malik', 'marcellus', 'percell', 'rasaan', 'rashaun', 'terrence', 'terryl',
              'theo', 'torrance', 'tyree', 'tyrone', 'wardell']
bl_f_names = ['aiesha', 'ebony', 'jasmine', 'lakisha', 'lashandra', 'lashelle', 'latisha', 'latonya', 'latoya',
              'malika', 'nichelle', 'shaniqua', 'shanise', 'sharise', 'shavonn', 'shereen', 'tameisha', 'tanisha',
              'tashika', 'tawanda', 'temeka', 'teretha', 'tia', 'yolanda', 'yvette']
...
term_dict = {
    ...
    'grooms': 'brides',  # 1
    'bridegroom': 'bride',
    'bridegrooms': 'brides',  # 1
    'best man': 'bridesmaid',
    'best men': 'bridesmaids',
    'fiance': 'fiancee',
    'fiancé': 'fiancée',
    'fiances': 'fiancees',
    'fiancés': 'fiancées',  # is there a plural?
    ...
    'doorman': 'portress', 'doormen': 'portresses',
    # porter is usually uses for men and women. Doorman however is male specific. So this is a good mapping.
